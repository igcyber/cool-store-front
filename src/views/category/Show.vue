        ...
        <div class="row px-xl-5">
            <div class="col-lg-12 col-md-12">
                <div class="row pb-3">
                    ...
                    <!-- product -->
                    <div v-for="product in productInCategory" :key="product.id" class="col-lg-4 col-md-6 col-sm-12 pb-1">
...
<script>
    ...
    export default {
        ...
        setup(){
            ...
            //computed properti yang digunakan untuk mendapatkan data products dari state productInCategory di module category vuex
            const productInCategory = computed(() => store.state.category.productInCategory);
