<template>
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            <div v-for="product in favoritesProduct" :key="product.id" class="col-lg-3 col-md-6 col-sm-12 pb-1">
...
<script>
    ...
    export default {
        name: 'TrandyProductComponent',
        setup(){
            //store vuex
            const store = useStore();

            //dapatkan data dari menjalankan action getProducts di module product
            onMounted(()=> {
            ...
            //filter data product yang akan ditampilkan
            const favoritesProduct = computed(() => {
                return products.value.filter(product => product.fav_product == 1)
            })
